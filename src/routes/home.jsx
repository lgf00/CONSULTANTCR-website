  ...
  return (
    <div className='home-content'>
      ...
      <div className='hero'>
        ...
        <img src={logo} alt='CONSULTANTCR, LLC' className='hero-logo'/>
      ...
      <div className='welcome-info'>
        ...
        <Link to='regulatory-support'>
          <button className="light-white-grad">
            Learn More
      ...
      <div className='reviewsec'>
        <div className='reviews content'>
          <div className='rev-sec'>
              <h1><span style={{color: "#FAF9F6"}}>What </span><span style={{color: "#748EC7"}}>People </span><span style={{color: "#FAF9F6"}}>Have Said</span></h1>
          ...
          <div className='rev-sec'>
            ...
            <Link to='contact'>
              <button className="blue-white-grad" style={{marginTop: '100px'}}>
                Get in Touch
                <span className='material-symbols-outlined'>
                    arrow_forward
                </span>
